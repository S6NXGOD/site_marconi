      ...
      <header className="flex flex-wrap items-end justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-full border border-conplan/20 px-5 py-2.5 text-sm font-semibold text-conplan transition-all hover:-translate-y-0.5 hover:bg-conplan-soft"
          >
            Novo alerta
          </Link>
        </div>
